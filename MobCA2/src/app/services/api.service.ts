...
export class ApiService {
  ...
  getEpisodes(){
      return this.http.get(`https://8100-c2aabc92-0885-4573-80f3-7e9bd80690b7.ws-eu01.gitpod.io/assets/episodes.json`);
  }
 ...
 getCharacters(){
      return this.http.get(`https://8100-c2aabc92-0885-4573-80f3-7e9bd80690b7.ws-eu01.gitpod.io/assets/characters.json`);
  }
 ...
 getQuotes(){
      return this.http.get(`https://8100-c2aabc92-0885-4573-80f3-7e9bd80690b7.ws-eu01.gitpod.io/assets/quotes.json`);
  }
 ...
 getDeaths(){     
    return this.http.get(`https://8100-c2aabc92-0885-4573-80f3-7e9bd80690b7.ws-eu01.gitpod.io/assets/deaths.json`);
  }
